...
//! Thus, a payload can only be finalized if participants with quorum weight certify it.
//!
...
//!
//! Therefore, a nullification covering `v` can only form if participants representing more than
